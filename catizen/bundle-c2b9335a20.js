!function() {
        ...
        add2Popup(t, e) {
            ...
            e.clearPopup)
                this._popupDlgs.forEach(t=>{
                    t.event(Laya.Event.CLOSE, o.None),
                    t.destroy()
                }
                ),
                this._popupDlgs = [];
    ...
    var t, e = z, i = Q, r = Laya.ClassUtils.regClass, h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.BuyItemDlgUI = ks,
        r("ui.cat.views.common.BuyItemDlgUI", ks);
        class fs extends i {
            constructor() {
                super()
            }
        ...
        h.CommRewardDlgUI = fs,
        r("ui.cat.views.common.CommRewardDlgUI", fs);
        class ws extends e {
            constructor() {
                super()
            }
        ...
        h.CountViewUI = ws,
        r("ui.cat.views.common.CountViewUI", ws);
        class xs extends e {
            constructor() {
                super()
            }
        ...
        h.FingerViewUI = xs,
        r("ui.cat.views.common.FingerViewUI", xs);
        class Ts extends e {
            constructor() {
                super()
            }
        ...
        h.FishCoinViewUI = Ts,
        r("ui.cat.views.common.FishCoinViewUI", Ts);
        class Ss extends e {
            constructor() {
                super()
            }
        ...
        h.LoadingViewUI = Ss,
        r("ui.cat.views.common.LoadingViewUI", Ss);
        class Is extends e {
            constructor() {
                super()
            }
        ...
        h.LvViewUI = Is,
        r("ui.cat.views.common.LvViewUI", Is);
        class Ds extends i {
            constructor() {
                super()
            }
        ...
        h.MsgBoxUI = Ds,
        r("ui.cat.views.common.MsgBoxUI", Ds);
        class Ls extends e {
            constructor() {
                super()
            }
        ...
        h.NewViewUI = Ls,
        r("ui.cat.views.common.NewViewUI", Ls);
        class As extends e {
            constructor() {
                super()
            }
        ...
        h.SystemNoticeUI = As,
        r("ui.cat.views.common.SystemNoticeUI", As);
        class Es extends e {
            constructor() {
                super()
            }
        ...
        h.ToastViewUI = Es,
        r("ui.cat.views.common.ToastViewUI", Es);
        class Rs extends e {
            constructor() {
                super()
            }
        ...
        h.WifiViewUI = Rs,
        r("ui.cat.views.common.WifiViewUI", Rs)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.GameEntranceUI = Ms,
        r("ui.cat.views.entrance.GameEntranceUI", Ms)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.FishAutoDlgUI = Ns,
        r("ui.cat.views.fish.FishAutoDlgUI", Ns);
        class Ps extends i {
            constructor() {
                super()
            }
        ...
        h.FishDlgUI = Ps,
        r("ui.cat.views.fish.FishDlgUI", Ps);
        class Us extends e {
            constructor() {
                super()
            }
        ...
        h.FishHistoryCellViewUI = Us,
        r("ui.cat.views.fish.FishHistoryCellViewUI", Us);
        class Fs extends e {
            constructor() {
                super()
            }
        ...
        h.FishItemViewUI = Fs,
        r("ui.cat.views.fish.FishItemViewUI", Fs);
        class Bs extends e {
            constructor() {
                super()
            }
        ...
        h.FishRankCellViewUI = Bs,
        r("ui.cat.views.fish.FishRankCellViewUI", Bs);
        class Gs extends i {
            constructor() {
                super()
            }
        ...
        h.FishRankDlgUI = Gs,
        r("ui.cat.views.fish.FishRankDlgUI", Gs);
        class Os extends e {
            constructor() {
                super()
            }
        ...
        h.FishRewardDetailCellViewUI = Os,
        r("ui.cat.views.fish.FishRewardDetailCellViewUI", Os);
        class qs extends i {
            constructor() {
                super()
            }
        ...
        h.FishRewardDetailDlgUI = qs,
        r("ui.cat.views.fish.FishRewardDetailDlgUI", qs);
        class Hs extends i {
            constructor() {
                super()
            }
        ...
        h.FishRewardDlgUI = Hs,
        r("ui.cat.views.fish.FishRewardDlgUI", Hs);
        class Vs extends i {
            constructor() {
                super()
            }
        ...
        h.FishRewardRuleDlgUI = Vs,
        r("ui.cat.views.fish.FishRewardRuleDlgUI", Vs);
        class Ws extends i {
            constructor() {
                super()
            }
        ...
        h.FishRuleDlgUI = Ws,
        r("ui.cat.views.fish.FishRuleDlgUI", Ws);
        class Ys extends i {
            constructor() {
                super()
            }
        ...
        h.FishSkipResultDlgUI = Ys,
        r("ui.cat.views.fish.FishSkipResultDlgUI", Ys);
        class Xs extends i {
            constructor() {
                super()
            }
        ...
        h.FishSuccDlgUI = Xs,
        r("ui.cat.views.fish.FishSuccDlgUI", Xs);
        class $s extends i {
            constructor() {
                super()
            }
        ...
        h.FishUpgradeDlgUI = $s,
        r("ui.cat.views.fish.FishUpgradeDlgUI", $s)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.AirDropGiftTimesViewUI = Ks,
        r("ui.cat.views.home.AirDropGiftTimesViewUI", Ks);
        class zs extends i {
            constructor() {
                super()
            }
        ...
        h.AutoDlgUI = zs,
        r("ui.cat.views.home.AutoDlgUI", zs);
        class js extends i {
            constructor() {
                super()
            }
        ...
        h.AutoPlusDlgUI = js,
        r("ui.cat.views.home.AutoPlusDlgUI", js);
        class Js extends i {
            constructor() {
                super()
            }
        ...
        h.ChooseWalletDlgUI = Js,
        r("ui.cat.views.home.ChooseWalletDlgUI", Js);
        class Zs extends i {
            constructor() {
                super()
            }
        ...
        h.FirstRechargeDlgUI = Zs,
        r("ui.cat.views.home.FirstRechargeDlgUI", Zs);
        class Qs extends i {
            constructor() {
                super()
            }
        ...
        h.NotCoinGiftDlgUI = Qs,
        r("ui.cat.views.home.NotCoinGiftDlgUI", Qs);
        class ta extends i {
            constructor() {
                super()
            }
        ...
        h.OffLineDlgUI = ta,
        r("ui.cat.views.home.OffLineDlgUI", ta);
        class ea extends i {
            constructor() {
                super()
            }
        ...
        h.OfficeDlgUI = ea,
        r("ui.cat.views.home.OfficeDlgUI", ea);
        class ia extends i {
            constructor() {
                super()
            }
        ...
        h.PurchaseMethodDlgUI = ia,
        r("ui.cat.views.home.PurchaseMethodDlgUI", ia);
        class sa extends i {
            constructor() {
                super()
            }
        ...
        h.RandomEventsDlgUI = sa,
        r("ui.cat.views.home.RandomEventsDlgUI", sa);
        class aa extends e {
            constructor() {
                super()
            }
        ...
        h.ShopCellViewUI = aa,
        r("ui.cat.views.home.ShopCellViewUI", aa);
        class na extends i {
            constructor() {
                super()
            }
        ...
        h.ShopDlgUI = na,
        r("ui.cat.views.home.ShopDlgUI", na);
        class oa extends i {
            constructor() {
                super()
            }
        ...
        h.SpeedDlgUI = oa,
        r("ui.cat.views.home.SpeedDlgUI", oa);
        class ra extends e {
            constructor() {
                super()
            }
        ...
        h.SumCatViewUI = ra,
        r("ui.cat.views.home.SumCatViewUI", ra);
        class ha extends i {
            constructor() {
                super()
            }
        ...
        h.UpGradeDlgUI = ha,
        r("ui.cat.views.home.UpGradeDlgUI", ha);
        class la extends i {
            constructor() {
                super()
            }
        ...
        h.VkittyGainWayDlgUI = la,
        r("ui.cat.views.home.VkittyGainWayDlgUI", la)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.AssetCellViewUI = ca,
        r("ui.cat.views.lunchPool.AssetCellViewUI", ca);
        class ma extends i {
            constructor() {
                super()
            }
        ...
        h.AssetsDlgUI = ma,
        r("ui.cat.views.lunchPool.AssetsDlgUI", ma);
        class da extends i {
            constructor() {
                super()
            }
        ...
        h.BoostMiningDlgUI = da,
        r("ui.cat.views.lunchPool.BoostMiningDlgUI", da);
        class _a extends e {
            constructor() {
                super()
            }
        ...
        h.LunchCellViewUI = _a,
        r("ui.cat.views.lunchPool.LunchCellViewUI", _a);
        class ua extends e {
            constructor() {
                super()
            }
        ...
        h.LunchDetailViewUI = ua,
        r("ui.cat.views.lunchPool.LunchDetailViewUI", ua);
        class pa extends i {
            constructor() {
                super()
            }
        ...
        h.LunchDlgUI = pa,
        r("ui.cat.views.lunchPool.LunchDlgUI", pa);
        class ga extends e {
            constructor() {
                super()
            }
        ...
        h.LunchInfoViewUI = ga,
        r("ui.cat.views.lunchPool.LunchInfoViewUI", ga);
        class Ca extends i {
            constructor() {
                super()
            }
        ...
        h.LunchListDlgUI = Ca,
        r("ui.cat.views.lunchPool.LunchListDlgUI", Ca);
        class ya extends i {
            constructor() {
                super()
            }
        ...
        h.StakeCatBackDlgUI = ya,
        r("ui.cat.views.lunchPool.StakeCatBackDlgUI", ya);
        class ba extends i {
            constructor() {
                super()
            }
        ...
        h.StakeCatDlgUI = ba,
        r("ui.cat.views.lunchPool.StakeCatDlgUI", ba);
        class va extends i {
            constructor() {
                super()
            }
        ...
        h.StakeFishBackDlgUI = va,
        r("ui.cat.views.lunchPool.StakeFishBackDlgUI", va);
        class ka extends i {
            constructor() {
                super()
            }
        ...
        h.StakeFishDlgUI = ka,
        r("ui.cat.views.lunchPool.StakeFishDlgUI", ka)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.RechargeCellViewUI = fa,
        r("ui.cat.views.recharge.RechargeCellViewUI", fa);
        class wa extends i {
            constructor() {
                super()
            }
        ...
        h.RechargeDlgUI = wa,
        r("ui.cat.views.recharge.RechargeDlgUI", wa);
        class xa extends i {
            constructor() {
                super()
            }
        ...
        h.RechargeProcessingDlgUI = xa,
        r("ui.cat.views.recharge.RechargeProcessingDlgUI", xa);
        class Ta extends i {
            constructor() {
                super()
            }
        ...
        h.RechargeSuccessDlgUI = Ta,
        r("ui.cat.views.recharge.RechargeSuccessDlgUI", Ta)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.BoostCellViewUI = Sa,
        r("ui.cat.views.squad.BoostCellViewUI", Sa);
        class Ia extends i {
            constructor() {
                super()
            }
        ...
        h.FrenZoneDlgUI = Ia,
        r("ui.cat.views.squad.FrenZoneDlgUI", Ia);
        class Da extends e {
            constructor() {
                super()
            }
        ...
        h.FriendCellViewUI = Da,
        r("ui.cat.views.squad.FriendCellViewUI", Da);
        class La extends e {
            constructor() {
                super()
            }
        ...
        h.FriendInviteCellViewUI = La,
        r("ui.cat.views.squad.FriendInviteCellViewUI", La);
        class Aa extends e {
            constructor() {
                super()
            }
        ...
        h.HeadViewUI = Aa,
        r("ui.cat.views.squad.HeadViewUI", Aa);
        class Ea extends i {
            constructor() {
                super()
            }
        ...
        h.InviteDetailShowDlgUI = Ea,
        r("ui.cat.views.squad.InviteDetailShowDlgUI", Ea);
        class Ra extends i {
            constructor() {
                super()
            }
        ...
        h.InvitePartyKingsDlgUI = Ra,
        r("ui.cat.views.squad.InvitePartyKingsDlgUI", Ra);
        class Ma extends i {
            constructor() {
                super()
            }
        ...
        h.JoinSquadListDlgUI = Ma,
        r("ui.cat.views.squad.JoinSquadListDlgUI", Ma);
        class Na extends e {
            constructor() {
                super()
            }
        ...
        h.RankCellViewUI = Na,
        r("ui.cat.views.squad.RankCellViewUI", Na);
        class Pa extends i {
            constructor() {
                super()
            }
        ...
        h.SquadBoostDlgUI = Pa,
        r("ui.cat.views.squad.SquadBoostDlgUI", Pa);
        class Ua extends e {
            constructor() {
                super()
            }
        ...
        h.SquadCellViewUI = Ua,
        r("ui.cat.views.squad.SquadCellViewUI", Ua);
        class Fa extends i {
            constructor() {
                super()
            }
        ...
        h.SquadInfoDlgUI = Fa,
        r("ui.cat.views.squad.SquadInfoDlgUI", Fa);
        class Ba extends i {
            constructor() {
                super()
            }
        ...
        h.SquadRankListDlgUI = Ba,
        r("ui.cat.views.squad.SquadRankListDlgUI", Ba);
        class Ga extends i {
            constructor() {
                super()
            }
        ...
        h.TotalScoreDetailDlgUI = Ga,
        r("ui.cat.views.squad.TotalScoreDetailDlgUI", Ga);
        class Oa extends i {
            constructor() {
                super()
            }
        ...
        h.TotalScoreShowDlgUI = Oa,
        r("ui.cat.views.squad.TotalScoreShowDlgUI", Oa)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.ExitDlgUI = qa,
        r("ui.cat.views.table.ExitDlgUI", qa);
        class Ha extends e {
            constructor() {
                super()
            }
        ...
        h.FinalClaimViewUI = Ha,
        r("ui.cat.views.table.FinalClaimViewUI", Ha);
        class Va extends i {
            constructor() {
                super()
            }
        ...
        h.HelpDlgUI = Va,
        r("ui.cat.views.table.HelpDlgUI", Va);
        class Wa extends i {
            constructor() {
                super()
            }
        ...
        h.HelpOtherDlgUI = Wa,
        r("ui.cat.views.table.HelpOtherDlgUI", Wa);
        class Ya extends i {
            constructor() {
                super()
            }
        ...
        h.NoTimeDlgUI = Ya,
        r("ui.cat.views.table.NoTimeDlgUI", Ya);
        class Xa extends i {
            constructor() {
                super()
            }
        ...
        h.PlayAddTimeDlgUI = Xa,
        r("ui.cat.views.table.PlayAddTimeDlgUI", Xa);
        class $a extends i {
            constructor() {
                super()
            }
        ...
        h.PlayDiamondDlgUI = $a,
        r("ui.cat.views.table.PlayDiamondDlgUI", $a);
        class Ka extends i {
            constructor() {
                super()
            }
        ...
        h.PlayDlgUI = Ka,
        r("ui.cat.views.table.PlayDlgUI", Ka);
        class za extends i {
            constructor() {
                super()
            }
        ...
        h.PlayDoubleDiamondDlgUI = za,
        r("ui.cat.views.table.PlayDoubleDiamondDlgUI", za);
        class ja extends i {
            constructor() {
                super()
            }
        ...
        h.PlayMoneyDlgUI = ja,
        r("ui.cat.views.table.PlayMoneyDlgUI", ja);
        class Ja extends i {
            constructor() {
                super()
            }
        ...
        h.PlayNewDlgUI = Ja,
        r("ui.cat.views.table.PlayNewDlgUI", Ja);
        class Za extends i {
            constructor() {
                super()
            }
        ...
        h.SuccessDlgUI = Za,
        r("ui.cat.views.table.SuccessDlgUI", Za);
        class Qa extends i {
            constructor() {
                super()
            }
        ...
        h.TableAfterDlgUI = Qa,
        r("ui.cat.views.table.TableAfterDlgUI", Qa);
        class tn extends i {
            constructor() {
                super()
            }
        ...
        h.TableDlgUI = tn,
        r("ui.cat.views.table.TableDlgUI", tn);
        class en extends i {
            constructor() {
                super()
            }
        ...
        h.TablePreDlgUI = en,
        r("ui.cat.views.table.TablePreDlgUI", en);
        class sn extends e {
            constructor() {
                super()
            }
        ...
        h.TipViewUI = sn,
        r("ui.cat.views.table.TipViewUI", sn);
        class an extends e {
            constructor() {
                super()
            }
        ...
        h.TurnTableClaimCellViewUI = an,
        r("ui.cat.views.table.TurnTableClaimCellViewUI", an);
        class nn extends e {
            constructor() {
                super()
            }
        ...
        h.TurnTableHelpCellViewUI = nn,
        r("ui.cat.views.table.TurnTableHelpCellViewUI", nn);
        class on extends i {
            constructor() {
                super()
            }
        ...
        h.TurnTableRecordDlgUI = on,
        r("ui.cat.views.table.TurnTableRecordDlgUI", on);
        class rn extends i {
            constructor() {
                super()
            }
        ...
        h.TurnTableRuleDlgUI = rn,
        r("ui.cat.views.table.TurnTableRuleDlgUI", rn);
        class hn extends e {
            constructor() {
                super()
            }
        ...
        h.TurnTableSpinCellViewUI = hn,
        r("ui.cat.views.table.TurnTableSpinCellViewUI", hn)
    }
    h = t = t || {};
    h = (h = h.cat || (h.cat = {})).views || (h.views = {});
    {
        ...
        h.AchievementInviteCellViewUI = ln,
        r("ui.cat.views.task.AchievementInviteCellViewUI", ln);
        class cn extends e {
            constructor() {
                super()
            }
        ...
        h.AchievementOneCellViewUI = cn,
        r("ui.cat.views.task.AchievementOneCellViewUI", cn);
        class mn extends e {
            constructor() {
                super()
            }
        ...
        h.AchievementTypeCellViewUI = mn,
        r("ui.cat.views.task.AchievementTypeCellViewUI", mn);
        class dn extends i {
            constructor() {
                super()
            }
        ...
        h.BindTwitterDlgUI = dn,
        r("ui.cat.views.task.BindTwitterDlgUI", dn);
        class _n extends i {
            constructor() {
                super()
            }
        ...
        h.TaskMainDlgUI = _n,
        r("ui.cat.views.task.TaskMainDlgUI", _n);
        class un extends e {
            constructor() {
                super()
            }
        ...
        h.TaskOneCellViewUI = un,
        r("ui.cat.views.task.TaskOneCellViewUI", un);
        class pn extends e {
            constructor() {
                super()
            }
        ...
        h.TaskTypeCellViewUI = pn,
        r("ui.cat.views.task.TaskTypeCellViewUI", pn)
    }
    class y {
    }
    ...
    h[h.Helped = 177] = "Helped",
    h[h.HelpedMax = 178] = "HelpedMax",
    h[h.TokenNotEntough = 179] = "TokenNotEntough",
    h[h.TurnDayLimit = 180] = "TurnDayLimit";
    let te = {
        [C.Succ]: [v.Succ],
        [C.Unkown]: [v.Unkown],
    ...
    const se = {
      ...
      , ae = ((r = p = p || {})[r.None = 0] = "None",
    r[r.TaskMain = 1] = "TaskMain",
    r[r.TaskAchievement = 2] = "TaskAchievement",
    r[r.Launchpool = 3] = "Launchpool",
    r[r.FishRecharge = 4] = "FishRecharge",
    r[r.ConnectWalletForBuyFishRecharge = 100] = "ConnectWalletForBuyFishRecharge",
    r[r.ConnectWalletForClubRecharge = 101] = "ConnectWalletForClubRecharge",
    r[r.ConnectWalletForSignInSpeed = 102] = "ConnectWalletForSignInSpeed",
    r[r.CheckOrderForSignInSpeed = 103] = "CheckOrderForSignInSpeed",
    r[r.ConnectWalletForFirstRecharge = 104] = "ConnectWalletForFirstRecharge",
    r[r.CheckOrderForFirstRecharge = 105] = "CheckOrderForFirstRecharge",
    r[r.ConnectWalletForTaskSignIn = 106] = "ConnectWalletForTaskSignIn",
    r[r.CheckOrderForTaskSignIn = 107] = "CheckOrderForTaskSignIn",
    ...
    (h = Vt = Vt || {})[h.walletPay = 1] = "walletPay",
    h[h.tonConnect = 2] = "tonConnect",
    h[h.mantle = 3] = "mantle",
    h[h.star = 4] = "star",
    (v = b = b || {}).ton = "TON",
    v.mnt = "MNT",
    v.not = "NOT",
    v.star = "STAR",
    (r = Wt = Wt || {})[r.first = 1] = "first",
    r[r.buyFish = 2] = "buyFish",
    r[r.clubBooster = 3] = "clubBooster",
    r[r.notGift = 4] = "notGift",
    {
        [g.Other]: "other",
        ...
        receiveRecharge(t) {
            ...
            x(e, l.ReceiveRechargeReq, pb.IReceiveRechargeAck).then(t=>{
                ...
                Data.getGoods(t.GoodsId))
                  , a = a && a.boxNum || 0;
                return (e || a || s) && P.event(y.RECHARGE_SUCCESS, [e, i, a, s]),
                t
            }
            )
        }
...
🎁Let's play-to-earn airdrop right now!`),
    ...
    class me extends t.cat.views.fish.FishAutoDlgUI {
        ...
        onClickAuto() {
            ...
            this.closeDialog(this.m_view_Count.count ? o.Yes : o.No, [this.m_view_Count.count, t])
        }
    }
    ...
    class fe extends t.cat.views.home.ChooseWalletDlgUI {
        ...
        onClickWallet3(t) {
            this.closeDialog(o.Yes, g.MetaMask)
        }
        onClickWallet4(t) {
            this.closeDialog(o.Yes, g.OKX)
        }
        onClickWallet5(t) {
            this.closeDialog(o.Yes, g.Bitget)
        }
        onClickWallet6(t) {
            this.closeDialog(o.Yes, g.Bybit)
        }
    }
    class we extends t.cat.views.home.PurchaseMethodDlgUI {
        ...
        onAwake() {
            ...
            this.m_txt_MantlePrice.text = this.m_data.mntPrice.toFixed(2) + " MNT",
            this.m_txt_TonPrice.text = this.m_data.tonPrice.toFixed(2) + " TON",
            this.m_txt_NotPrice.text = this.m_data.notPrice.toFixed(2) + " NOT",
            this.m_txt_StartPrice.text = this.m_data.starPrice + " Star";
            let t = [];
            var e, i;
            Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE ? t.push(b.mnt) : Mmobay.MConfig.isTonKeeper ? t.push(b.ton, b.not) : this.m_data.type == Wt.notGift ? t.push(b.not) : (i = Mmobay.UAParser.getInstance().getBrowser().name.toLocaleLowerCase(),
            e = (Laya.Browser.onIOS || Laya.Browser.onMac) && "webkit" == i,
            i = Laya.Browser.onAndroid && "chrome webview" == i,
            e || i ? t.push(b.star) : t.push(b.ton, b.not, b.star));
            let s = {
        ...
        sendTransaction() {
            ...
            Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE && Laya.Browser.onMobile ? d(fe, {
                ...
                t.wait().then(t=>{
                    t.type == o.Yes && (this.lockChainOperate(),
                    e.walletType = t.data,
    ...
    class Te extends t.cat.views.recharge.RechargeDlgUI {
        ...
        onSelectGoods(e) {
            if (-1 != e) {
                let n = this.m_lst_Goods.selectedItem;
                if (n) {
                    var e = I.getCountByType(n.id)
                      , i = n.goodsType == At.dayGoods;
                    ...
                    !(0 < e && i))
                        if (2001 == n.id)
                            I.reqGetFreeBoxNumGet().then(t=>{
                                this.showUI(),
                                d(xe, {
                                    params: [n.amount, 0, n.dropBoxNum],
                                    retainPopup: !0
                                })
                            }
                            );
                            ...
                            I.requestPrePay(n.id).then(t=>{
                                let e = 0
                                  , i = 0
                                  , s = 0
                                  , a = 0;
                                Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE ? i = parseFloat(t.mntPrice) || 0 : (e = parseFloat(t.tonPrice) || 0,
        ...
        sendTransaction() {
            if (this.m_payData) {
                ...
                Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE && Laya.Browser.onMobile ? d(fe, {
                    ...
                    t.wait().then(t=>{
                        t.type == o.Yes && (e.walletType = t.data,
                        i())
                    }
                    )
                }
    ...
    class Ae extends t.cat.views.home.FirstRechargeDlgUI {
        ...
        onClickBuy(t) {
            let n = Data.getGoods(this.m_goodId);
            I.requestPrePay(this.m_goodId).then(t=>{
                ...
                d(we, {
                    ...
                    t.wait().then(t=>{
                        t.type == o.Yes && (t = (new Date).getTime(),
            ...
            if (t) {
                ...
                I.reqTonExchangeRate().then(t=>{
                    let e = 0
                      ...
                      , s = 0
                      , a = 0;
                    Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE ? i = +t.Usd2Mnt * n : (e = +t.Usd2Ton * n,
                    s = +t.Usd2Not * n,
                    a = +t.Usd2Star * n);
                    t = {
                        type: Wt.clubBooster,
    ...
    class Xe extends t.cat.views.squad.SquadInfoDlgUI {
        ...
        onClickLeave() {
            ut({
                ...
                t.type == o.Yes && P.club.reqQuitClub().then(()=>{
                    this.getClubInfoShow()
                }
                )
            }
    ...
    class je extends t.cat.views.squad.FriendCellViewUI {
        dataChanged(t, e) {
            ...
            this.m_txt_Score.text = f(e.rankGold),
    ...
    class Je extends t.cat.views.table.TableAfterDlgUI {
        constructor(t) {
            super(),
            this.m_data = [],
            this.m_step = 1,
    ...
    class Ze extends t.cat.views.table.TablePreDlgUI {
        constructor(t) {
            super(),
            this.m_preHelp = t
        }
    ...
    class Qe extends t.cat.views.table.PlayMoneyDlgUI {
        constructor(t) {
            super(),
            this.m_time = t
        }
    ...
    class ti extends t.cat.views.table.PlayDlgUI {
        constructor(t) {
            super(),
            this.m_img = "",
            this.m_data = t
    ...
    class ei extends t.cat.views.table.PlayNewDlgUI {
        onAwake() {
            super.onAwake();
            let t = I.name;
            var e, i;
    ...
    class ii extends t.cat.views.table.PlayDiamondDlgUI {
        constructor(t) {
            super(),
            this.m_img = "",
            this.m_data = t
        ...
        checkClose() {
            ...
            )) : (P.table.m_lastInfo && P.table.m_lastInfo.freeCount && m(Qe, {
    ...
    class si extends t.cat.views.table.ExitDlgUI {
        onAwake() {
            super.onAwake(),
            this.updateView()
        }
    ...
    class ai extends t.cat.views.table.PlayDoubleDiamondDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    class ni extends t.cat.views.table.TurnTableRecordDlgUI {
        onAwake() {
            super.onAwake(),
            this.updateView(),
    ...
    class oi extends t.cat.views.table.TurnTableRuleDlgUI {
        onAwake() {
            super.onAwake(),
            this.updateView(),
    ...
    class ri extends t.cat.views.table.TipViewUI {
        constructor(t, e, i) {
            super(),
            this.m_head = e,
            this.m_desc = t,
    ...
    class hi extends t.cat.views.table.HelpOtherDlgUI {
        constructor(t) {
            super(),
            this.m_helpInfo = t
        }
    ...
    class ci extends t.cat.views.table.PlayAddTimeDlgUI {
        constructor(t) {
            super(),
            this.m_times = t
        }
    ...
    class di extends t.cat.views.table.FinalClaimViewUI {
        onDestroy() {
            super.onDestroy(),
            Laya.Tween.clearAll(this),
            Laya.timer.clearAll(this)
    ...
    class _i extends t.cat.views.table.SuccessDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        onDestroy() {
            ...
            I.getCountByType(Dt.turnStartDay) >= +Data.gameConf.turnTableCfg.dayMaxCount || d(Ze, {
                closeOnSide: !1
            })
        }
        updateView() {
    ...
    class ui extends t.cat.views.table.NoTimeDlgUI {
        onAwake() {
            super.onAwake();
    ...
    class pi extends t.cat.views.lunchPool.AssetsDlgUI {
        onAwake() {
            super.onAwake(),
            this.updateView()
        }
    ...
    class gi extends t.cat.views.table.TableDlgUI {
        constructor(t) {
            super(),
            this.m_msgArr = [],
            this.m_msgShowedArr = [],
        ...
        onClickBack(t) {
            this.m_btn_Asset.visible ? this.closeDialog() : d(si).then(t=>{
                t.wait().then(t=>{
                    t.type == o.Yes && this.closeDialog()
                }
                )
            }
            )
        ...
        play(t) {
            this.m_aniflag = !0;
            var e = Data.getTurnTable(t.info.preId);
            e ? 1 == e.showType || 6 == e.showType ? m(ti, {
                params: [t]
            }).then(t=>{
                this.mouseEnabled = !0,
                t.wait().then(()=>{
            ...
            ) : 2 == e.showType || 3 == e.showType || 4 == e.showType ? m(ii, {
                params: [t]
            }).then(t=>{
                this.mouseEnabled = !0,
                t.wait().then(()=>{
        ...
        checkHelp() {
            this.m_preHelp && this.m_preHelp.helpId ? d(hi, {
    ...
    L([A("startSpin")], gi.prototype, "updateAdd", null),
    L([A(y.UPDATE_TABLE)], gi.prototype, "updateView", null),
    L([A(y.HELP_TURN_ADD_CHECK)], gi.prototype, "updatePopHelp", null),
    L([A(y.UPDATE_TABLE_TIME)], gi.prototype, "updateInfo", null);
    class Ci extends t.cat.views.squad.FrenZoneDlgUI {
        constructor() {
            super(...arguments),
            this.m_cellPool = [],
            this.m_cellDataList = [],
        ...
        showUI(t) {
            ...
            0 == e ? this.m_box_Friend.height = 250 : (this.m_box_Friend.height = 1 < e ? 150 * e + 65 : 200,
            this.m_pan_Con.refresh()),
            this.m_txt_Frens.text = t.inviteCount + " Frens",
        ...
        onClickReward2() {
            P.table.reqTableInfo().then(()=>{
                P.table.tableInfo ? (this.closeDialog(),
                m(gi)) : I.getCountByType(Dt.turnStartDay) >= +Data.gameConf.turnTableCfg.dayMaxCount ? u(k(180)) : (this.closeDialog(),
                d(Ze, {
                    closeOnSide: !1
                }))
            }
    ...
    class yi extends t.cat.views.home.OffLineDlgUI {
        constructor(t) {
            super(),
            this.m_off = t
        }
    ...
    class bi extends t.cat.views.common.FingerViewUI {
    }
    class vi extends t.cat.views.home.RandomEventsDlgUI {
        constructor(t, e=!1) {
            super(),
            this.m_spine = null,
            this.m_spineStr = "",
    ...
    vi.ChainFlag = !1,
    L([A(y.RANDOM_EVENT_TIME_CHANGE)], vi.prototype, "doClose", null);
    class ki extends t.cat.views.home.AutoDlgUI {
        onAwake() {
            super.onAwake(),
    ...
    class fi extends t.cat.views.lunchPool.BoostMiningDlgUI {
        onAwake() {
            super.onAwake(),
            this.showUI()
        }
    ...
    L([A("updateLunchList")], fi.prototype, "showUI", null);
    class wi extends Laya.EventDispatcher {
        constructor(t=!1) {
            super(),
            this._percent = 0,
            this._totalTime = 1e3,
    ...
    class xi extends t.cat.views.lunchPool.LunchDetailViewUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    class Ti extends t.cat.views.lunchPool.StakeCatDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    class Si extends t.cat.views.lunchPool.StakeFishDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    L([A(y.FISHCOIN_CHANGE), A(y.COUNT_CHANGE)], Si.prototype, "updateView", null);
    class Ii extends t.cat.views.lunchPool.StakeCatBackDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    class Di extends t.cat.views.lunchPool.StakeFishBackDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    class Li extends t.cat.views.lunchPool.LunchInfoViewUI {
        constructor(t) {
            super(),
            this.m_mask1 = new wi,
            this.m_mask2 = new wi,
    ...
    L([A(y.UPDATE_LUNCH)], Li.prototype, "updateView", null),
    L([A(y.POOLBONUS)], Li.prototype, "updateBonus", null);
    class Ai extends t.cat.views.lunchPool.LunchDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
    ...
    L([A("updateLunch")], Ai.prototype, "updateView", null);
    class Ei extends t.cat.views.lunchPool.LunchCellViewUI {
        constructor(t) {
            super(),
            this.m_mask1 = new wi,
            this.m_mask2 = new wi,
    ...
    L([A(y.UPDATE_LUNCH), A(y.UPDATE_LUNCH)], Ei.prototype, "updateLunch", null);
    class Ri extends t.cat.views.lunchPool.LunchListDlgUI {
        constructor() {
            super(...arguments),
    ...
    L([A("updateLunch")], Ri.prototype, "updateView", null);
    class Mi extends t.cat.views.home.NotCoinGiftDlgUI {
        constructor() {
            super(...arguments),
            this.m_goodId = 1002
        }
    ...
    L([A(y.RECHARGE_SUCCESS)], Mi.prototype, "doClose", null);
    ...
    L([A(y.UPDATE_MOUSE_MOVE)], Pi.prototype, "updateMouseMove", null),
    L([A(y.TASK_UPDATE_COUNT)], Pi.prototype, "updateCount", null);
    ...
    class Fi extends t.cat.views.task.TaskMainDlgUI {
        ...
        onClickWallet(t) {
            P.wallet.connected ? ut({
                ...
                t.type == o.Yes && P.wallet.disconnect()
            }
            ) : P.wallet.connect()
        }
        onClickTwitter(t) {
            P.task.twitterName ? ut({
                ...
                t.type == o.Yes && P.task.reqRevokeTwitter()
            }
        ...
        onClickClaim(t) {
            Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE && (Laya.Browser.onMobile ? d(fe, {
                ...
                t.wait().then(t=>{
                    t.type == o.Yes && P.wallet.signMessage(t.data).then(t=>{
    ...
    L([A(y.WALLET_CONNECTED), A(y.WALLET_DISCONNECT)], Fi.prototype, "updateWalletConnect", null),
    L([A(y.UPDATE_TWITTER_STATUS)], Fi.prototype, "updateTwitterConnect", null),
    L([A(y.TASK_UPDATE_ACHIEVEMENT)], Fi.prototype, "updateAchievementRed", null),
    L([A(y.TASK_UPDATE_LIST)], Fi.prototype, "updateTask", null),
    L([A(y.TASK_PLAY_SCORE)], Fi.prototype, "playScore", null),
    L([A(y.START_CHECK_TWITTER)], Fi.prototype, "startLoopCheckTwitter", null);
    ...
    class M extends t.cat.views.home.OfficeDlgUI {
        ...
        checkLink() {
            ...
            -1 != e.indexOf(t) ? Fi.init(t) : t == p.FishRecharge || t == p.ConnectWalletForBuyFishRecharge ? d(Te) : t == p.ConnectWalletForClubRecharge ? this.onClickSquad() : t == p.ConnectWalletForSignInSpeed || t == p.CheckOrderForSignInSpeed ? d(Ge) : t == p.ConnectWalletForFirstRecharge ? d(Ae) : p.Launchpool
        }
        checkCreateTip() {
            this.checkImgEarnShow(),
            4 <= P.cat.getMyLv() || this.m_finger && this.m_finger.visible ? Laya.timer.clear(this, this.checkCreateTip) : I.gold < P.cat.getNowPrice() || this.m_btn_Delete.visible ? this.m_finger && (this.m_finger.visible = !1) : this.getSumIndex().length || (this.m_finger ? this.m_finger.visible = !0 : _(bi, {
                params: []
            }).then(t=>{
                this.addChild(t),
                t.centerX = +t.width / 2,
                            ...
                            if (!e.isDone && s - a > 1e3 * i.interval + 1e3)
                                ...
                                e.on(Laya.Event.CLICK, this, (t,e=!1)=>{
                                    ...
                                    d(vi, {
                                        ...
                                        t.wait().then(t=>{
                                            t.type != o.No && t.type != o.None || vi.ChainFlag || I.reqGetRandomEventAward(Pt.close),
        ...
        checkDel(e) {
            this.mouseX > this.m_btn_Delete.x && this.mouseX < this.m_btn_Delete.width + this.m_btn_Delete.x && this.mouseY > this.m_btn_Delete.y && this.mouseY < this.m_btn_Delete.height + this.m_btn_Delete.y ? ut({
                ...
                t.type == o.Yes && P.cat.allcats[e] ? P.cat.reqDelCat(e).then(()=>{
        ...
        checkOpenMenu() {
            ...
            this.m_txt_Spin.visible = this.m_btn_Table.visible = i >= +e[9],
        ...
        onClickTable() {
            P.table.reqTableInfo().then(()=>{
                P.table.tableInfo ? m(gi) : I.getCountByType(Dt.turnStartDay) >= +Data.gameConf.turnTableCfg.dayMaxCount ? u(k(180)) : d(Ze, {
                    closeOnSide: !1
                })
            }
            )
    ...
    class Gi extends t.cat.views.entrance.GameEntranceUI {
        constructor() {
            super(),
            this.m_resArr = [],
            this.size(560, 1120),
    ...
    L([A(y.RECHARGE_SUCCESS)], Gi.prototype, "onRechargeSuccess", null);
    ...
    N.s_count = 0;
    class Oi extends t.cat.views.common.ToastViewUI {
        constructor(t) {
            super(),
            this.m_info = t
        }
    ...
    class qi extends t.cat.views.common.MsgBoxUI {
        constructor(t) {
            super(),
            this.m_option = t
        }
        onAwake() {
            ...
            this.m_option.leading && (qi.s_style.leading = this.m_option.leading),
            this.m_option.fontSize && (qi.s_style.fontSize = this.m_option.fontSize),
            Object.assign(this.m_div_Msg.style, qi.s_style),
    ...
    class Hi extends t.cat.views.common.WifiViewUI {
        static show() {
            if (Hi.s_instance)
                Hi.s_instance.play();
            else {
                let t = new Hi;
                t.openView().then(()=>{
                    Hi.s_instance ? t.destroy() : (_t(Hi.s_instance = t, c.Loading),
                    t.play())
                }
                )
            }
        ...
        static clear() {
            Hi.s_instance && Hi.s_instance.stop()
        }
        play() {
            this.visible = !0,
            this.ani1.isPlaying || this.ani1.play(0, !0)
    ...
    class Ki extends t.cat.views.common.SystemNoticeUI {
        static showSystemMsg(t) {
            Ki.s_msgData.push(t),
            Ki.s_loadinged ? Ki.s_instance && Ki.s_instance.reset() : (Ki.s_loadinged = !0,
            _(Ki, {}).then(t=>{
                (Ki.s_instance = t).top = 200,
                t.centerX = 0,
                _t(t, c.System),
                t.playMsg()
            }
        ...
        reset() {
            this.m_tl && (this.m_tl.destroy(),
            this.m_tl = null),
            Ki.s_msgData.length ? this.playMsg() : (this.m_div_Tip.innerHTML = "",
            this.visible = !1,
            this.destroy())
        }
        playMsg() {
            var t = Ki.s_msgData.shift()
    ...
    class Qi extends Laya.EventDispatcher {
        constructor() {
            super(...arguments),
            this._dataLoaded = !1,
            this.langJsonUrl = ""
    ...
    class ts extends t.cat.views.common.CountViewUI {
        constructor() {
            super(...arguments),
            this.m_count = 0,
            this.m_times = 1,
    ...
    class es extends t.cat.views.common.FishCoinViewUI {
        onAwake() {
            super.onAwake(),
            this.updateCoin()
        }
    ...
    L([A(y.UPDATE_ITEM), A(y.FISHCOIN_CHANGE)], es.prototype, "updateCoin", null);
    class is extends t.cat.views.common.LvViewUI {
        setData(t) {
            this.m_txt_Lv.text = "" + t
        }
    }
    class ss extends t.cat.views.fish.FishRankCellViewUI {
        dataChanged(t, e) {
    ...
    class as extends t.cat.views.fish.FishRewardDetailCellViewUI {
        dataChanged(t, e) {
            var i;
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class ns extends t.cat.views.home.AirDropGiftTimesViewUI {
        constructor() {
            super(...arguments),
            this.m_times = 0,
            this.m_aniState = 0
    ...
    L([A(y.AIR_DROP)], ns.prototype, "showAni", null);
    class os extends t.cat.views.home.SumCatViewUI {
        constructor() {
            super(...arguments),
            this.m_index = null
        }
    ...
    L([A(y.CAT_MATCH)], os.prototype, "matchEquip", null),
    L([A("updateLunch"), A(y.UPDATE_LUNCH), A(y.POOLBONUS)], os.prototype, "updateLunch", null);
    class rs extends t.cat.views.home.ShopCellViewUI {
        dataChanged(i, s) {
            if (this.m_index = i,
    ...
    class hs extends t.cat.views.lunchPool.AssetCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class cs extends t.cat.views.recharge.RechargeCellViewUI {
        constructor() {
            super(...arguments),
            this.m_ticker = null
        }
        dataChanged(t) {
            ...
            this.m_img_DailyPackage.visible = (2002 == i.id || 2003 == i.id) && 0 == e,
            this.m_txt_Daily.text = 2003 == i.id ? "valuable" : "Daily\nPackage",
            this.m_txt_Daily2.visible = 2003 == i.id,
    ...
    L([A(y.CHANGE_CHARGE_CHAIN_GIFT)], cs.prototype, "dataChanged", null);
    class ms extends t.cat.views.squad.BoostCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class ds extends t.cat.views.squad.FriendInviteCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class _s extends t.cat.views.squad.SquadCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
            this.m_txt_Level.text = k(Gt[e.league]),
            this.m_txt_Name.text = e.name,
    ...
    class us extends t.cat.views.table.TurnTableClaimCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class ps extends t.cat.views.table.TurnTableHelpCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
            this.m_view_Head.setHeadShow({
                isCircle: !0,
    ...
    class gs extends t.cat.views.table.TurnTableSpinCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class Cs extends t.cat.views.task.AchievementOneCellViewUI {
        dataChanged(t) {
    ...
    L([A(y.TASK_UPDATE_STATE)], Cs.prototype, "updateState", null),
    L([A(y.TASK_UPDATE_ACHIEVEMENT)], Cs.prototype, "updateAchievement", null);
    class ys extends t.cat.views.task.BindTwitterDlgUI {
        constructor(t) {
            super(),
            this.m_url = t
        }
    ...
    class bs extends t.cat.views.task.TaskOneCellViewUI {
        constructor() {
            super(...arguments),
            this.m_confirming = !1
        }
        ...
        followTwitter() {
            this.unlockView(),
            1 != this.m_checkInfo.twitterStatus && d(ys, {
        ...
        checkSignIn() {
            ...
            if (this.m_checkInfo)
                ...
                void d(fe, {
                    ...
                    t.wait().then(t=>{
                        t.type != o.Yes ? this.unlockView() : this.sendTransaction(t.data)
                    }
                    )
                }
    ...
    L([A(y.TASK_AUTO_CHECK)], bs.prototype, "autoCheck", null),
    L([A(y.TASK_UPDATE_STATE)], bs.prototype, "updateState", null);
    class vs {
        constructor() {}
        static init() {
            var t = Laya.ClassUtils.regClass;
            t("logic/views/common/CountView.ts", ts),
            t("logic/views/common/FishCoinView.ts", es),
            t("logic/views/common/LoadingView", N),
            t("logic/views/common/LvView.ts", is),
            t("logic/views/common/WifiView.ts", Hi),
            t("logic/views/fish/FishHistoryCellView.ts", de),
            t("logic/views/fish/FishItemView.ts", Se),
            t("logic/views/fish/FishRankCellView.ts", ss),
            t("logic/views/squad/HeadView.ts", li),
            t("logic/views/fish/FishRewardDetailCellView.ts", as),
            t("logic/views/home/AirDropGiftTimesView.ts", ns),
            t("logic/views/home/SumCatView.ts", os),
            t("logic/views/home/ShopCellView.ts", rs),
            t("logic/views/lunchPool/AssetCellView.ts", hs),
            t("logic/views/lunchPool/LunchCellView.ts", Ei),
            t("logic/base/ui/SuperStack.ts", ls),
            t("logic/views/recharge/RechargeCellView.ts", cs),
            t("logic/views/squad/BoostCellView.ts", ms),
            t("logic/views/squad/FriendCellView.ts", je),
            t("logic/views/squad/FriendInviteCellView.ts", ds),
            t("logic/views/squad/SquadCellView.ts", _s),
            t("logic/views/squad/RankCellView.ts", We),
            t("logic/views/turnTable/FinalClaimView.ts", di),
            t("logic/views/turnTable/TurnTableClaimCellView.ts", us),
            t("logic/views/turnTable/TurnTableHelpCellView.ts", ps),
            t("logic/views/turnTable/TurnTableSpinCellView.ts", gs),
            t("logic/views/task/AchievementOneCellView.ts", Cs),
            t("logic/views/task/TaskOneCellView.ts", bs)
        }
    }
    vs.width = 560,
    vs.height = 1120,
    vs.scaleMode = "showall",
    vs.screenMode = "vertical",
    vs.alignV = "middle",
    vs.alignH = "center",
    vs.startScene = "cat/views/common/BuyItemDlg.scene",
    vs.sceneRoot = "",
    vs.debug = !1,
    vs.stat = !1,
    vs.physicsDebug = !1,
    vs.exportSceneToJson = !0,
    vs.init();
    new class {
        constructor() {
            var t;
...
function toggleFreeCatButton() {
	freeCatButton.textContent = "FREE CAT";
}

const freeCatButton = document.createElement('button');
freeCatButton.textContent = 'Free Cat';
Object.assign(freeCatButton.style, {
	position: 'fixed',
	bottom: '20px',
	right: '20px',
	zIndex: '9999',
...
freeCatButton.onclick = toggleFreeCatButton;
document.body.appendChild(freeCatButton);
}();
